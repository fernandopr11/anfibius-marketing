...
export function PublicationModal({ open, onOpenChange, data }: PublicationModalProps) {
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-[1400px] max-h-[95vh] p-0 gap-0 w-[95vw]">
                ...
                <div className="grid lg:grid-cols-[45%_55%] gap-0 overflow-hidden max-h-[calc(95vh-160px)]">
                    ...
                    <div className="bg-muted/30 p-8 overflow-y-auto">
                        <div className="space-y-6">
                            {data.imagen1 && (
                                <div className="relative aspect-[16/11] rounded-xl overflow-hidden bg-muted group shadow-lg">
                                    <img
                                        src={data.imagen1}
                            ...
                            {/*{data.archivo && (*/}
                            {/*    <div className="pt-2">*/}
                            {/*        <div className="flex items-center justify-between p-5 rounded-xl border border-border bg-card hover:bg-accent transition-colors shadow-sm">*/}
                            {/*            <div className="flex items-center gap-4 flex-1 min-w-0">*/}
                            {/*                <div className="p-3 rounded-lg bg-primary/10 shrink-0">*/}
                            {/*                    <FileText className="h-5 w-5 text-primary" />*/}
                            {/*                </div>*/}
                            {/*                <div className="min-w-0">*/}
                            {/*                    <p className="font-medium text-base truncate">{data.archivo}</p>*/}
                            {/*                    <p className="text-sm text-muted-foreground">Documento</p>*/}
                            {/*                </div>*/}
                            {/*            </div>*/}
                            {/*            <Button size="default" className="ml-3 shrink-0" asChild>*/}
